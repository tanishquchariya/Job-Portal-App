...
const JobDescription = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto my-10 text-gray-900 dark:text-gray-100'>            <div className='flex items-center justify-between'>
            <div>
            ...
            <Button
                ...
                disabled={isApplied}
                className={`rounded-lg transition-all duration-200 ${isApplied
                        ? 'bg-gray-500 text-white dark:bg-gray-700 dark:text-gray-200 cursor-not-allowed'
